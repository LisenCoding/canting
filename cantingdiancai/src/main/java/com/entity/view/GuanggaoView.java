...
*/
@TableName("guanggao")
public class GuanggaoView extends GuanggaoEntity implements Serializable {
	...
	* 广告类型的值
	*/
	@ColumnInfo(comment="广告类型的字典表值",type="varchar(200)")
	...
	//级联表 店家
		...
		*/
		...
		@ColumnInfo(comment="店家名称",type="varchar(200)")
		...
		* 店家类型
		*/
		@ColumnInfo(comment="店家类型",type="int(11)")
		private Integer shangjiaTypes;
			/**
			* 店家类型的值
			*/
			@ColumnInfo(comment="店家类型的字典表值",type="varchar(200)")
		...
		*/
		...
		@ColumnInfo(comment="店家介绍",type="longtext")
	...
	public GuanggaoView(GuanggaoEntity guanggaoEntity) {
		try {
			BeanUtils.copyProperties(this, guanggaoEntity);
	...
	* 获取： 广告类型的值
	*/
	public String getGuanggaoValue() {
		return guanggaoValue;
	}
	/**
	* 设置： 广告类型的值
	*/
	public void setGuanggaoValue(String guanggaoValue) {
		this.guanggaoValue = guanggaoValue;
	}
