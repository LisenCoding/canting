...
import huanyuan from '@/views/modules/databaseBackup/huanyuan'
    ...
    import guanggao from '@/views/modules/guanggao/list'
    ...
    import dictionaryGuanggao from '@/views/modules/dictionaryGuanggao/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryGuanggao',
        name: '广告类型',
        component: dictionaryGuanggao
    }
    ,{
        path: '/dictionaryNews',
        name: '资讯类型',
