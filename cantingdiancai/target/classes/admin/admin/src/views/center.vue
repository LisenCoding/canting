<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='店家名称' prop="shangjiaName">
               <el-input v-model="ruleForm.shangjiaName"  placeholder='店家名称' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='shangjia'"  label='店家类型' prop="shangjiaTypes">
                 <el-select v-model="ruleForm.shangjiaTypes"  placeholder='请选择店家类型'>
                     <el-option
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='shangjia'"  label="店家介绍" prop="shangjiaContent">
                 <editor
